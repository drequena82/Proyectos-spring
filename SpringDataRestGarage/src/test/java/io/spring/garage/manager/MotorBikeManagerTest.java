...
public class MotorBikeManagerTest {
    ...
    public void testFindAll() {
        // Act
        List<MotorBike> all = this.manager.findAll();
    ...
    public void testDelete() {
        // Arrange
        final MotorBike motorBike = this.manager.get(1L);

        // Act
        this.manager.delete(motorBike);
